...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                    ...
                    ┌─────────────────────┼─────────────────────┐
                    │                     │                     │
            定期数据获取              策略执行调度           报告生成任务
         (每分钟获取价格数据)       (每日9:30执行策略)     (每周生成绩效报告)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

核心特性：
1. 异步执行：基于asyncio的异步任务调度，不阻塞主线程
2. 时间灵活性：支持秒/分/时/日/周多种时间单位
3. 时区支持：自动处理不同时区的任务调度
4. 任务管理：支持任务标签、取消、重试等高级功能
